...
const Home = ({isAuthenticated})=> {
  ...
  return (
    <>
      ...
      <div className="container-fluid">
        <div className={`navbar-header`}>
          ...
          <a className={`${styles.navbarBrand} navbar-brand`} href="#">Learnify</a>
        </div>
      ...
      <div className={styles.bannerTitle}>
        <h1 className={styles.bannerHead}>Learn without limits</h1>
        <p className={styles.bannerLead}>Move your creative journey forward without putting life on hold. Skillshare's short online classes help you find inspiration that fits your routine.</p>
        <br/>
    ...
    <div className={styles.headline}>What can you do with Learnify?</div>
    ...
    <div className={styles.reminder}>
      ...
      <Button title="Try Learnify now" onClickHandler={onTryNowBtnClick}/>
    </div>
    <div className={styles.footer}>
    <a className={`${styles.navbarBrand}`} href="#">Learnify</a>
    <p className={styles.footerText}>Copyright© 2022 Learnify. All rights reserved.</p>
    </div>
    </HomeLayout>
    </>
  )
